...
namespace Lab3
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            FigureFactory.RegisterFactory(new LineFactory());
            FigureFactory.RegisterFactory(new CircleFactory());
            FigureFactory.RegisterFactory(new RectangleFactory());

            FigureComboBox.ItemsSource = FigureFactory.GetNames();
        ...
        private void DrawCanvas_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            currentFactory = FigureFactory.GetByName(selectedName);
